...
<div class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="fw-bold">
            <i class="bi bi-person-badge-fill me-2"></i>Detail Data Guru BK
        </h3>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="card p-3 shadow-sm border-start border-primary border-4">
                    <strong><i class="bi bi-person-badge me-2"></i>NIP:</strong>
                    <p class="mb-0">{{ $counselor->id_number }}</p>
                </div>
            </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="card p-3 shadow-sm border-start border-success border-4">
                    ...
                    <p class="mb-0">{{ $counselor->email }}</p>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card p-3 shadow-sm border-start border-success border-4">
                    ...
                    <p class="mb-0">{{ $counselor->phone ?? '-' }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card p-3 shadow-sm border-start border-info border-4">
                    ...
                    <p class="mb-0">{{ $counselor->address ?? '-' }}</p>
                </div>
            </div>
        </div>
    </div>
