...
<head>
    <meta charset="utf-8">
    <title>Konseling Disetujui</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; margin: 0 auto; padding: 20px; max-width: 600px;">
    <div style="background-color: #fff; border-radius: 8px; border: 2px solid #c0c0c0; border-radius: 8px; padding: 30px; box-shadow: 0 15px 30px rgba(0, 0, 0, 0.3); border-bottom: 8px solid #5A6C57;">
        ...
        <div style="padding: 20px 0; text-align: center;">
            ...
            <p>Pengajuan konseling Anda telah disetujui. Berikut adalah detail konseling Anda:</p>
            
            <div style="background: #f9f9f9; padding: 15px; border-radius: 5px; margin: 20px 0;">
                <p><strong>Judul Konseling:</strong> {{ $contents['title'] }}</p>
                <p><strong>Tanggal & Waktu:</strong> {{ $contents['scheduled_at'] }}</p>
                <p><strong>Catatan Meeting Konseling:</strong></p>
                <p>{{ $contents['notes'] }}</p>
            </div>

            <p>Silakan klik tombol di bawah ini untuk mengakses detail konseling:</p>
            
            <div style="text-align: center; margin: 25px 0;">
                <a href="{{ $contents['url'] }}" style="display: inline-block; padding: 10px 30px; background-color: #5A6C57; color: #fff; text-decoration: none; border-radius: 1.5rem; font-weight: bold;">Lihat Detail</a>
            </div>

            <p>Jika Anda memiliki pertanyaan, silakan hubungi konselor Anda.</p>
        </div>
