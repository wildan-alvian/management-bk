...
<body style="font-family: Arial, sans-serif; line-height: 1.6; margin: 0 auto; padding: 20px; max-width: 600px;">
    <div style="background-color: #fff; border-radius: 8px; border: 2px solid #c0c0c0; border-radius: 8px; padding: 30px; box-shadow: 0 15px 30px rgba(0, 0, 0, 0.3); border-bottom: 8px solid #dc3545;">
        ...
        <div style="padding: 20px 0; text-align: center;">
            ...
            <p>Mohon maaf, pengajuan konseling Anda telah ditolak. Berikut adalah detail konseling Anda:</p>
            ...
            <p>Silakan klik tombol di bawah ini untuk melihat detail konseling:</p>
            
            <div style="text-align: center; margin: 25px 0;">
                <a href="{{ $contents['url'] }}" style="display: inline-block; padding: 10px 30px; background-color: #fff; color: #dc3545; border: 1px solid #dc3545; text-decoration: none; border-radius: 1.5rem; font-weight: bold;">Lihat Detail</a>
            </div>
