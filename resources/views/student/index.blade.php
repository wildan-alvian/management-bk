...
<div class="container mt-5" style="font-family: 'Kumbh Sans';">
    <div class="container mt-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="d-flex">
                <form method="GET" action="{{ route('student.index') }}" class="d-flex">
                ...
                @if(request('search'))
                <a href="{{ route('student.index') }}" class="btn btn-outline-secondary me-3"> <i class="bi bi-x-circle-fill"></i>
                @endif

                <a href="{{ route('student.create') }}" class="btn text-white fw-bold btn-orange">
                    + Tambah Siswa
                </a>
            </div>
        </div>
        ...
        <div class="table-responsive">
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('student.show', $student->id) }}" class="btn btn-sm btn-link" style="font-size: 18px;">
